...
Bonus: this example no longer works if <code>n ** 2</code> is written as <code>n * n</code>.
</>,
...
explanation: 
<>
<code>Math.round(double)</code> returns a <code>long</code> and in the case of <code>Double.NaN</code> it just casts the input to a <code>long</code>, which results in <code>0</code>. 
</>,
credit: 'Madjosz',
...
explanation: 
<>
Automatic Semicolon Insertion doesn't put a semicolon at the end of the first line. This code is interpreted as <code>const something = 2["print", "string", "with its index"].forEach((s, i) =&gt; console.log(s, i))</code>.
</>,
credit: 'Blind4Basics',
